    ...
    static let all: [ChatToolSpec] = [
        ...
        ChatToolSpec(
            ...
            parameters: obj([
                ...
                "brand": str("Optional brand or restaurant"),
                "serving_description": str("Optional display label, e.g. '1 serving (42 g)'"),
                "serving_quantity": num("Numeric amount represented by the saved nutrition values, usually 1"),
                "serving_unit": str("Unit represented by serving_quantity, e.g. serving, bar, cup"),
                "serving_grams": num("Gram weight of that complete saved serving. When known, always provide this so grams is selectable when logging."),
        ...
        ChatToolSpec(
            ...
            parameters: obj([
                ...
                "serving_description": str("New display label"),
                "serving_quantity": num("New numeric serving amount"),
                "serving_unit": str("New base serving unit"),
                "serving_grams": num("Gram weight of the complete saved serving"),
                "micronutrients": arr("Micronutrients to add or replace by canonical nutrient name. Existing nutrients not listed are preserved.", items: micronutrientSchema),
                "remove_micronutrients": arr("Nutrient names or canonical IDs to remove", items: str("Nutrient name or canonical ID")),
            ], required: ["food_id"]),
            isWrite: true
