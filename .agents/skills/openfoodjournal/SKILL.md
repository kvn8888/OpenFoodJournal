...
User taps Scan → CameraController (AVCaptureSession) → 1-4 photos
  → Camera view uses one native continuous zoom slider over AVFoundation's system-recommended range
